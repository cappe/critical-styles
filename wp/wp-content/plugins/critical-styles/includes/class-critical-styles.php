...
class Critical_Styles {
	...
	public function __construct() {
		if ( defined( 'CRITICAL_STYLES_VERSION' ) ) {
			$this->version = CRITICAL_STYLES_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	 ...
	 *
	 * - Critical_Styles_Loader. Orchestrates the hooks of the plugin.
	 * - Critical_Styles_i18n. Defines internationalization functionality.
	 * - Critical_Styles_Admin. Defines all hooks for the admin area.
	 * - Critical_Styles_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Critical_Styles_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Critical_Styles_i18n();
