 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Critical Styles
 * Plugin URI:        localhost:8000
 * Description:       This is a short description of what the plugin does. It's displayed in the WordPress admin area.
 * Version:           1.0.0
 * Author:            Kasperi Keski-Loppi
 * Author URI:        https://www.linkedin.com/in/kasperi-keski-loppi-637935142
 * License:           GPL-2.0+
 * License URI:       http://www.gnu.org/licenses/gpl-2.0.txt
 * Text Domain:       critical-styles
 ...
 */
define( 'CRITICAL_STYLES_VERSION', '1.0.0' );
...
register_activation_hook( __FILE__, 'activate_critical_styles' );
register_deactivation_hook( __FILE__, 'deactivate_critical_styles' );
